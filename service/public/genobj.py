...
if DEBUG:
    with open('C:/Users/rustemd/divenact/service/public/sample_input.yml', 'r') as inputfile:
        inputstring = inputfile.read()
    inputdata = yaml.load(inputstring, Loader=yaml.FullLoader)
else:
    with open('C:/Users/rustemd/divenact/service/public/sample_input.json', 'r') as inputfile:
        inputstring = inputfile.read()
