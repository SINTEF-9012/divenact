...
import { Button, Layout, Col, Row, Menu, Table, Popconfirm, Tooltip, Dropdown } from 'antd';
          ...
          <span style={{float: 'right'}}>
            <ButtonGroup size='small' type="dashed">
              <Dropdown overlay={
                <Menu>
                <Menu.Item key="0">
                  <Button type="link" onClick={(event) => this.deployVariant(record, 'production')}>Production</Button>
                </Menu.Item>
                <Menu.Divider />
                <Menu.Item key="1">
                  <Button type="link" onClick={(event) => this.deployVariant(record, 'preview')}>Preview</Button>
                </Menu.Item>
                <Menu.Divider />
                <Menu.Item key="3">
                  <Button type="link" onClick={(event) => this.deployVariant(record, 'testing')}>Testing</Button>
                </Menu.Item>
                <Menu.Divider />
                <Menu.Item key="4">         
                  <Button type="link" onClick={(event) => this.deployVariant(record, 'safe-mode')}>Safe mode</Button>
                </Menu.Item>
              </Menu>
